function Dialog(e, t, n, i) {
    this._shadowBlock = n, this._popupBlock = i, this._shadow = t, this._popup = e, this._changeDialog = function () {
        this._shadow = 1 != this._shadow, this._popup = 1 != this._popup, 1 == this._shadow && 1 == this._popup ? (this._shadowBlock.show(), this._popupBlock.show(), $("html, body").css("overflowY", "hidden")) : (this._shadowBlock.hide(), this._popupBlock.hide(), $("html, body").css("overflowY", "auto"))
    ...
    function o(e) {
        var t = !!e && "length" in e && e.length,
            n = i(e);
        return !me(e) && !we(e) && ("array" === n || 0 === t || "number" == typeof t && t > 0 && t - 1 in e)
    }
    ...
    function s(e, t, n) {
        return me(t) ? xe.grep(e, function (e, i) {
    ...
    function l(e) {
        var t = {};
        return xe.each(e.match(Ne) || [], function (e, n) {
            t[n] = !0
        }), t
    }
    ...
    function b(e, t) {
        for (var n, i, o = [], r = 0, s = e.length; r < s; r++)(i = e[r]).style && (n = i.style.display, t ? ("none" === n && (o[r] = ze.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && Xe(i) && (o[r] = w(i))) : "none" !== n && (o[r] = "none", ze.set(i, "display", n)));
    ...
    function T(e, t, n, o, r) {
        for (var s, a, l, c, d, u, p = t.createDocumentFragment(), f = [], h = 0, v = e.length; h < v; h++)
            ...
            for (a = a || p.appendChild(t.createElement("div")), l = (Qe.exec(s) || ["", ""])[1].toLowerCase(), c = Ke[l] || Ke._default, a.innerHTML = c[1] + xe.htmlPrefilter(s) + c[2], u = c[0]; u--;) a = a.lastChild;
            xe.merge(f, a.childNodes), (a = p.firstChild).textContent = ""
        } else f.push(t.createTextNode(s));
        for (p.textContent = "", h = 0; s = f[h++];)
            if (o && xe.inArray(s, o) > -1) r && r.push(s);
            else if (d = xe.contains(s.ownerDocument, s), a = x(p.appendChild(s), "script"), d && k(a), n)
    ...
    function L(e, t, i, o) {
        ...
        var r, s, a, l, c, d, u = 0,
            ...
            h = t[0],
            v = me(h);
        if (v || p > 1 && "string" == typeof h && !ye.checkClone && st.test(h)) return e.each(function (n) {
            var r = e.eq(n);
            v && (t[0] = h.call(this, n, r.html())), L(r, t, i, o)
        });
        if (p && (r = T(t, e[0].ownerDocument, !1, e, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || o)) {
            for (l = (a = xe.map(x(r, "script"), D)).length; u < p; u++) c = r, u !== f && (c = xe.clone(c, !0, !0), l && xe.merge(a, x(c, "script"))), i.call(e[u], c, u);
            if (l)
                for (d = a[a.length - 1].ownerDocument, xe.map(a, j), u = 0; u < l; u++) c = a[u], Je.test(c.type || "") && !ze.access(c, "globalEval") && xe.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? xe._evalUrl && xe._evalUrl(c.src) : n(c.textContent.replace(at, ""), d, c))
        }
        return e
    }
    ...
    function P(e, t, n) {
        ...
        return (n = n || ct(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || xe.contains(e.ownerDocument, e) || (s = xe.style(e, t)), !ye.pixelBoxStyles() && lt.test(s) && dt.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function W(e, t, n, i, o, r) {
        ...
        for (; s < 4; s += 2) "margin" === n && (l += xe.css(e, n + Ue[s], !0, o)), i ? ("content" === n && (l -= xe.css(e, "padding" + Ue[s], !0, o)), "margin" !== n && (l -= xe.css(e, "border" + Ue[s] + "Width", !0, o))) : (l += xe.css(e, "padding" + Ue[s], !0, o), "padding" !== n ? l += xe.css(e, "border" + Ue[s] + "Width", !0, o) : a += xe.css(e, "border" + Ue[s] + "Width", !0, o));
    ...
    function R(e, t, n) {
        ...
        return s = s && (ye.boxSizingReliable() || o === e.style[t]), ("auto" === o || !parseFloat(o) && "inline" === xe.css(e, "display", !1, i)) && (o = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (o = parseFloat(o) || 0) + W(e, t, n || (r ? "border" : "content"), s, i, o) + "px"
    }
    ...
    function F() {
        mt && (!1 === se.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(F) : e.setTimeout(F, xe.fx.interval), xe.fx.tick())
    }
    ...
    function Y(e, t, n) {
        ...
        for (i in t)
            ...
            u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = ze.get(e, "display")), "none" === (d = xe.css(e, "display")) && (c ? d = c : (b([e], !0), c = e.style.display || c, d = xe.css(e, "display"), b([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === xe.css(e, "float") && (l || (p.done(function () {
                h.display = c
            }), null == c && (d = h.display, c = "none" === d ? "" : d)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function () {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), l = !1;
            for (i in f) l || (g ? "hidden" in g && (v = g.hidden) : g = ze.access(e, "fxshow", {
                display: c
            }), r && (g.hidden = !v), v && b([e], !0), p.done(function () {
                v || b([e]), ze.remove(e, "fxshow");
                for (i in f) xe.style(e, i, f[i])
            })), l = X(v ? g[i] : 0, i, p), i in g || (g[i] = l.start, v && (l.end = l.start, l.start = 0))
        }
    }
    ...
    function G(e, t, n) {
        var i, o, r = 0,
            ...
            l = function () {
                if (o) return !1;
                for (var t = yt || _(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, s = c.tweens.length; r < s; r++) c.tweens[r].run(i);
        ...
        for (V(d, c.opts.specialEasing); r < s; r++)
            if (i = G.prefilters[r].call(c, e, d, c.opts)) return me(i.stop) && (xe._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return xe.map(d, X, c), me(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), xe.fx.timer(xe.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    function Z(e, t, n, o) {
        ...
        if (Array.isArray(t)) xe.each(t, function (t, i) {
            n || Ht.test(e) ? o(e, i) : Z(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, o)
        });
    ...
    var Te = function (e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : R) !== L && N(t), t = t || L, P)) {
                if (11 !== h && (l = ye.exec(e)))
                    if (o = l[1]) {
                        if (9 === h) {
                    ...
                    if (1 !== h) p = t, d = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(xe, ke) : t.setAttribute("id", a = W), r = (c = $(e)).length; r--;) c[r] = "#" + a + " " + f(c[r]);
            ...
            var o = n.length > 0,
                ...
                s = function (i, s, a, l, c) {
                    var d, u, p, f = 0,
                        ...
                        x = w.length;
                    for (c && (D = s === L || s || c); h !== x && null != (d = w[h]); h++) {
                        if (r && d) {
                            for (u = 0, s || d.ownerDocument === L || (N(d), a = !P); p = e[u++];)
                                if (p(d, s || L, a)) {
                                    l.push(d);
                                    break
                                } c && (B = b)
        ...
        var x, k, T, S, C, $, A, E, D, j, H, N, L, O, P, q, M, I, z, W = "sizzle" + 1 * new Date,
            R = e.document,
            B = 0,
            F = 0,
            _ = n(),
        ...
        k = t.support = {}, C = t.isXML = function (e) {
            ...
            return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, O = L.documentElement, P = !C(L), R !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), k.attributes = o(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), k.getElementsByTagName = o(function (e) {
                return e.appendChild(L.createComment("")), !e.getElementsByTagName("*").length
            }), k.getElementsByClassName = ge.test(L.getElementsByClassName), k.getById = o(function (e) {
            ...
            })), (k.matchesSelector = ge.test(I = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && o(function (e) {
                k.disconnectedMatch = I.call(e, "*"), I.call(e, "[s!='']:x"), M.push("!=", re)
            }), q = q.length && new RegExp(q.join("|")), M = M.length && new RegExp(M.join("|")), t = ge.test(O.compareDocumentPosition), z = t || ge.test(O.contains) ? function (e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !k.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === R && z(R, e) ? -1 : t === L || t.ownerDocument === R && z(R, t) ? 1 : j ? ee(j, e) - ee(j, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return H = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== L && N(e), n = n.replace(de, "='$1']"), k.matchesSelector && P && !X[n + " "] && (!M || !M.test(n)) && (!q || !q.test(n))) try {
                var i = I.call(e, n);
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (H = !k.detectDuplicates, j = !k.sortStable && e.slice(0), e.sort(Y), H) {
                    ...
                    return 1 === i && 0 === o ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [s ? g.firstChild : g.lastChild], s && m) {
                                for (w = (f = (c = (d = (u = (p = g)[W] || (p[W] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === B && c[1]) && c[2], p = f && g.childNodes[f]; p = ++f && p && p[v] || (w = f = 0) || h.pop();)
                                    if (1 === p.nodeType && ++w && p === t) {
                                        d[e] = [B, f, w];
                                        break
                                    }
                            } else if (m && (w = f = (c = (d = (u = (p = t)[W] || (p[W] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === B && c[1]), !1 === w)
                                for (;
                                    (p = ++f && p && p[v] || (w = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++w || (m && ((d = (u = p[W] || (p[W] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [B, w]), p !== t)););
        ...
        return p.prototype = T.filters = T.pseudos, T.setFilters = new p, $ = t.tokenize = function (e, n) {
            ...
            var n, i = [],
                ...
                r = X[e + " "];
            if (!r) {
                for (t || (t = $(e)), n = t.length; n--;)(r = w(t[n]))[W] ? i.push(r) : o.push(r);
            ...
            var o, r, s, a, l, c = "function" == typeof e && e,
                d = !i && $(e = c.selector || e);
            if (n = n || [], 1 === d.length) {
                if ((r = d[0] = d[0].slice(0)).length > 2 && "ID" === (s = r[0]).type && 9 === t.nodeType && P && T.relative[r[1].type]) {
                    if (!(t = (T.find.ID(s.matches[0].replace(we, be), t) || [])[0])) return n;
                    c && (t = t.parentNode), e = e.slice(r.shift().value.length)
                }
                for (o = fe.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)
                    if ((l = T.find[a]) && (i = l(s.matches[0].replace(we, be), me.test(r[0].type) && u(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = i.length && f(r))) return K.apply(n, i), n;
                        break
                    }
            }
            return (c || A(e, d))(i, t, !P, n, !t || me.test(e) && u(t.parentNode) || t), n
        }, k.sortStable = W.split("").sort(Y).join("") === W, k.detectDuplicates = !!H, N(), k.sortDetached = o(function (e) {
    ...
    (xe.fn.init = function (e, t, n) {
        ...
        if (n = n || Ee, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof xe ? t[0] : t, xe.merge(this, xe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : se, !0)), Ae.test(i[1]) && xe.isPlainObject(t))
                    for (i in t) me(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
            return (o = se.getElementById(i[2])) && (this[0] = o, this.length = 1), this
        }
        return e.nodeType ? (this[0] = e, this.length = 1, this) : me(e) ? void 0 !== n.ready ? n.ready(e) : e(xe) : xe.makeArray(e, this)
    }).prototype = xe.fn, Ee = xe(se);
    ...
    xe.fn.extend({
        ...
        xe.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = xe.filter(i, o)), this.length > 1 && (He[e] || xe.uniqueSort(o), je.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var Ne = /[^\x20\t\r\n\f]+/g;
    xe.Callbacks = function (e) {
                ...
                add: function () {
                    return s && (n && !t && (c = s.length - 1, a.push(n)), function t(n) {
                        xe.each(n, function (n, o) {
                            me(o) ? e.unique && u.has(o) || s.push(o) : o && o.length && "string" !== i(o) && t(o)
                        })
                ...
                o = {
                    ...
                    then: function (t, i, o) {
                                ...
                                var a = this,
                                    ...
                                    u = function () {
                                        ...
                                        if (!(t < s)) {
                                            ...
                                            u = e && ("object" == typeof e || "function" == typeof e) && e.then, me(u) ? o ? u.call(e, r(s, n, c, o), r(s, n, d, o)) : (s++, u.call(e, r(s, n, c, o), r(s, n, d, o), r(s, n, c, n.notifyWith))) : (i !== c && (a = void 0, l = [e]), (o || n.resolveWith)(a, l))
                                        }
                                    },
                                    p = o ? u : function () {
                                        try {
                        ...
                        return xe.Deferred(function (e) {
                            n[0][3].add(r(0, e, me(o) ? o : c, e.notifyWith)), n[1][3].add(r(0, e, me(t) ? t : c)), n[2][3].add(r(0, e, me(i) ? i : d))
                        }).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            ...
            if (t <= 1 && (u(e, r.done(s(n)).resolve, r.reject, !t), "pending" === r.state() || me(o[n] && o[n].then))) return r.then();
    ...
    xe.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --xe.readyWait : xe.isReady) || (xe.isReady = !0, !0 !== e && --xe.readyWait > 0 || Oe.resolveWith(se, [xe]))
        }
    }), xe.ready.then = Oe.then, "complete" === se.readyState || "loading" !== se.readyState && !se.documentElement.doScroll ? e.setTimeout(xe.ready) : (se.addEventListener("DOMContentLoaded", p), e.addEventListener("load", p));
    var Pe = function (e, t, n, o, r, s, a) {
            ...
            } else if (void 0 !== o && (r = !0, me(o) || (a = !0), d && (a ? (t.call(e, o), t = null) : (d = t, t = function (e, t, n) {
    ...
    xe.extend({
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (o = We.get(r), 1 === r.nodeType && !ze.get(r, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = h(i.slice(5)), y(r, i, o[i]));
        ...
        queue: function (e, t, n) {
            var i;
            if (e) return t = (t || "fx") + "queue", i = ze.get(e, t), n && (!i || Array.isArray(n) ? i = ze.access(e, t, xe.makeArray(n)) : i.push(n)), i || []
        },
    ...
    xe.event = {
        ...
        add: function (e, t, n, i, o) {
            var r, s, a, l, c, d, u, p, f, h, v, g = ze.get(e);
            if (g)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && xe.find.matchesSelector(et, o), n.guid || (n.guid = xe.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (t) {
                        return void 0 !== xe && xe.event.triggered !== t.type ? xe.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(Ne) || [""]).length; c--;) f = v = (a = it.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = xe.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = xe.event.special[f] || {}, d = xe.extend({
                    type: f,
                    origType: v,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, r), (p = l[f]) || ((p = l[f] = []).delegateCount = 0, u.setup && !1 !== u.setup.call(e, i, h, s) || e.addEventListener && e.addEventListener(f, s)), u.add && (u.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, d) : p.push(d), xe.event.global[f] = !0)
        },
        remove: function (e, t, n, i, o) {
            var r, s, a, l, c, d, u, p, f, h, v, g = ze.hasData(e) && ze.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(Ne) || [""]).length; c--;)
                    if (a = it.exec(t[c]) || [], f = v = a[1], h = (a[2] || "").split(".").sort(), f) {
                        for (u = xe.event.special[f] || {}, p = l[f = (i ? u.delegateType : u.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;) d = p[r], !o && v !== d.origType || n && n.guid !== d.guid || a && !a.test(d.namespace) || i && i !== d.selector && ("**" !== i || !d.selector) || (p.splice(r, 1), d.selector && p.delegateCount--, u.remove && u.remove.call(e, d));
    ...
    xe.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (r = r || x(e), s = s || x(a), i = 0, o = r.length; i < o; i++) H(r[i], s[i]);
                else H(e, a);
    ...
    ! function () {
        ...
        c.style && (c.style.backgroundClip = "content-box", c.cloneNode(!0).style.backgroundClip = "", ye.clearCloneStyle = "content-box" === c.style.backgroundClip, xe.extend(ye, {
    ...
    xe.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (r = typeof n) && (o = _e.exec(n)) && o[1] && (n = m(e, t, o), r = "number"), null != n && n === n && ("number" === r && (n += o && o[3] || (xe.cssNumber[a] ? "" : "px")), ye.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function (e, t, n, i) {
            var o, r, s, a = h(t);
            return pt.test(t) || (t = I(a)), (s = xe.cssHooks[t] || xe.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = P(e, t, i)), "normal" === o && t in ht && (o = ht[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), xe.each(["height", "width"], function (e, t) {
        xe.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !ut.test(xe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? R(e, t, i) : Ye(e, ft, function () {
                    return R(e, t, i)
                })
            },
            set: function (e, n, i) {
                var o, r = ct(e),
                    ...
                    a = i && W(e, t, i, s, r);
                return s && ye.scrollboxSize() === r.position && (a -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - W(e, t, "border", !1, r) - .5)), a && (o = _e.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = xe.css(e, t)), z(e, n, a)
            }
        }
    ...
    xe.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? xe.prop(e, t, n) : (1 === r && xe.isXMLDoc(e) || (o = xe.attrHooks[t.toLowerCase()] || (xe.expr.match.bool.test(t) ? xt : void 0)), void 0 !== n ? null === n ? void xe.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = xe.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    xe.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : me(e) ? this.each(function (n) {
                ...
                var t, o, r, s;
                if (i)
                    for (o = 0, r = xe(this), s = K(e); t = s[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                else void 0 !== e && "boolean" !== n || ((t = J(this)) && ze.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : ze.get(this, "__className__") || ""))
            })
        },
        hasClass: function (e) {
            var t, n, i = 0;
    ...
    xe.extend(xe.event, {
        trigger: function (t, n, i, o) {
            ...
            if (s = p = a = i = i || se, 3 !== i.nodeType && 8 !== i.nodeType && !$t.test(h + xe.event.triggered) && (h.indexOf(".") > -1 && (h = (v = h.split(".")).shift(), v.sort()), c = h.indexOf(":") < 0 && "on" + h, t = t[xe.expando] ? t : new xe.Event(h, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = v.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : xe.makeArray(n, [t]), u = xe.event.special[h] || {}, o || !u.trigger || !1 !== u.trigger.apply(i, n))) {
                ...
                for (r = 0;
                    (s = f[r++]) && !t.isPropagationStopped();) p = s, t.type = r > 1 ? l : u.bindType || h, (d = (ze.get(s, "events") || {})[t.type] && ze.get(s, "handle")) && d.apply(s, n), (d = c && s[c]) && d.apply && Ie(s) && (t.result = d.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = h, o || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(f.pop(), n) || !Ie(i) || c && me(i[h]) && !we(i) && ((a = i[c]) && (i[c] = null), xe.event.triggered = h, t.isPropagationStopped() && p.addEventListener(h, At), i[h](), t.isPropagationStopped() && p.removeEventListener(h, At), xe.event.triggered = void 0, a && (i[c] = a)), t.result
            }
        },
    ...
    xe.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !xe(this).is(":disabled") && Ot.test(this.nodeName) && !Lt.test(e) && (this.checked || !Ge.test(e))
            }).map(function (e, t) {
                var n = xe(this).val();
    ...
    Ut.href = Et.href, xe.extend({
        ...
        ajax: function (t, n) {
            function i(t, n, i, a) {
                var c, p, f, b, x, k = n;
                d || (d = !0, l && e.clearTimeout(l), o = void 0, s = a || "", T.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (b = ie(h, T, i)), b = oe(h, b, T, c), c ? (h.ifModified && ((x = T.getResponseHeader("Last-Modified")) && (xe.lastModified[r] = x), (x = T.getResponseHeader("etag")) && (xe.etag[r] = x)), 204 === t || "HEAD" === h.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = b.state, p = b.data, c = !(f = b.error))) : (f = k, !t && k || (k = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (n || k) + "", c ? y.resolveWith(v, [p, k, T]) : y.rejectWith(v, [T, k, f]), T.statusCode(w), w = void 0, u && g.trigger(c ? "ajaxSuccess" : "ajaxError", [T, h, c ? p : f]), m.fireWith(v, [T, k]), u && (g.trigger("ajaxComplete", [T, h]), --xe.active || xe.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var o, r, s, a, l, c, d, u, p, f, h = xe.ajaxSetup({}, n),
                v = h.context || h,
            ...
            if (y.promise(T), h.url = ((t || h.url || Et.href) + "").replace(Rt, Et.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ne) || [""], null == h.crossDomain) {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = xe.param(h.data, h.traditional)), te(Bt, h, n, T), d) return T;
            (u = xe.event && h.global) && 0 == xe.active++ && xe.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Wt.test(h.type), r = h.url.replace(qt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Pt, "+")) : (f = h.url.slice(r.length), h.data && (h.processData || "string" == typeof h.data) && (r += (jt.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(Mt, "$1"), f = (jt.test(r) ? "&" : "?") + "_=" + Dt++ + f), h.url = r + f), h.ifModified && (xe.lastModified[r] && T.setRequestHeader("If-Modified-Since", xe.lastModified[r]), xe.etag[r] && T.setRequestHeader("If-None-Match", xe.etag[r])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + _t + "; q=0.01" : "") : h.accepts["*"]);
            for (p in h.headers) T.setRequestHeader(p, h.headers[p]);
            if (h.beforeSend && (!1 === h.beforeSend.call(v, T, h) || d)) return T.abort();
            if (k = "abort", m.add(h.complete), T.done(h.success), T.fail(h.error), o = te(Ft, h, n, T)) {
        ...
        xe[t] = function (e, n, i, o) {
            return me(n) && (o = o || i, i = n, n = void 0), xe.ajax(xe.extend({
                url: e,
                type: t,
                dataType: o,
                data: n,
        ...
        wrapAll: function (e) {
            var t;
            return this[0] && (me(e) && (e = e.call(this[0])), t = xe(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function () {
    ...
    ye.cors = !!Yt && "withCredentials" in Yt, ye.ajax = Yt = !!Yt, xe.ajaxTransport(function (t) {
        var n, i;
        if (ye.cors || Yt && !t.crossDomain) return {
            send: function (o, r) {
                var s, a = t.xhr();
    ...
    xe.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = me(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Gt, "$1" + o) : !1 !== t.jsonp && (t.url += (jt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
            return s || xe.error(o + " was not called"), s[0]
        }, t.dataTypes[0] = "json", r = e[o], e[o] = function () {
            s = arguments
        }, i.always(function () {
            void 0 === r ? xe(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, Vt.push(o)), s && me(r) && r(s[0]), s = r = void 0
        }), "script"
        ...
        var i, o, r;
        return t || (ye.createHTMLDocument ? ((i = (t = se.implementation.createHTMLDocument("")).createElement("base")).href = se.location.href, t.head.appendChild(i)) : t = se), o = Ae.exec(e), r = !n && [], o ? [t.createElement(o[1])] : (o = T([e], t, r), r && r.length && xe(r).remove(), xe.merge([], o.childNodes))
    }, xe.fn.load = function (e, t, n) {
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return a > -1 && (i = Q(e.slice(a)), e = e.slice(0, a)), me(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && xe.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var i, o, r, s, a, l, c = xe.css(e, "position"),
                d = xe(e),
                u = {};
            "static" === c && (e.style.position = "relative"), a = d.offset(), r = xe.css(e, "top"), l = xe.css(e, "left"), ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1 ? (s = (i = d.position()).top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), me(t) && (t = t.call(e, n, xe.extend({}, a))), null != t.top && (u.top = t.top - a.top + s), null != t.left && (u.left = t.left - a.left + o), "using" in t ? t.using.call(e, u) : d.css(u)
        }
    }, xe.fn.extend({
        offset: function (e) {
    ...
    }, xe.isArray = Array.isArray, xe.parseJSON = JSON.parse, xe.nodeName = r, xe.isFunction = me, xe.isWindow = we, xe.camelCase = h, xe.type = i, xe.now = Date.now, xe.isNumeric = function (e) {
        var t = xe.type(e);
...
$(".popup__show").click(function () {
    ...
    $(this).hasClass("show-menu--active") ? ($(this).removeClass("show-menu--active"), $(".nav").removeClass("nav--active")) : ($(this).addClass("show-menu--active"), $(".nav").addClass("nav--active"))
}), $(document).ready(function () {
    $(".slider--header").slick({
        autoplay: !0,
        autoplaySpeed: 2e3
